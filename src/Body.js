      ...
      <section id="home" class="home light d-flex align-items-center">
		<div class="container">
			...
			<div class="intro">
				...
				{/* <!-- info --> */}
				<h1 class="mb-2 mt-0">Mocktar Issa</h1>
				<span>I'm a <span class="text-rotating">Full stack web Developer, Software engineer, Devops professional,  machine learning enthousiast</span></span>
