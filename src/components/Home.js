      ...
      <section id="home" className="home light d-flex align-items-center">
        <div className="container">
          ...
          <div className="intro">
            ...
            <span>
              I'm a{" "}
              <span className="text-rotating rotating-text">
                Software Consultant, Full stack web Developer, Software
                engineer, Devops professional, Machine learning enthousiast
              </span>
            </span>
            ...
            <ul className="social-icons light list-inline mb-0 mt-5">
              <li className="list-inline-item">
                <a href="https://www.instagram.com/mocktar_issa/">
                  <i className="fab fa-instagram"></i>
                </a>
              </li>
              <li className="list-inline-item">
                <a href="https://twitter.com/mocktarissa">
                  <i className="fab fa-twitter"></i>
                </a>
              </li>
              <li className="list-inline-item">
                <a href="https://github.com/mocktarissa">
                  <i className="fab fa-github"></i>
                </a>
              </li>
              <li className="list-inline-item">
                <a href="https://medium.com/@mocktarissa">
                  <i className="fab fa-medium"></i>
                </a>
              </li>
              <li className="list-inline-item">
                <a href="https://www.linkedin.com/in/mocktar-issa-30a9674a/">
